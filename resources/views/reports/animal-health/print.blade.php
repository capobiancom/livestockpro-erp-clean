        ...
        <style>
            ...
            * {
            ...
            @media print {
                ...
                /* Keep header and table headers consistent across pages */
                thead {
            ...
            <div class="header">
                ...
                <div class="header-bottom">
                    <div class="kv">
                        ...
                        <div class="v">
                            @php
                                $typeLabel = $filters['event_type'] ?? 'health_events';
                                if ($typeLabel === 'disease_treatments') {
                                    $typeLabel = 'Disease Treatments';
                                } elseif ($typeLabel === 'vaccinations') {
                                    $typeLabel = 'Vaccinations';
                                } else {
                                    $typeLabel = 'Health Events';
                                }
                            @endphp
                            {{ $typeLabel }}
                        </div>
                        ...
                        <div class="k">Health issue</div>
                        <div class="v">
                            @php
                                $issueLabel = '—';
                                if (($filters['event_type'] ?? 'health_events') === 'health_events') {
                                    $issueLabel = 'All issues';
                                    if (!empty($filters['health_issue_id'])) {
                                        $h = collect($healthIssues)->firstWhere('id', (int) $filters['health_issue_id']);
                                        $issueLabel = $h ? ($h['name'] ?? 'Selected issue') : 'Selected issue';
                                    }
                                }
                            @endphp
                            {{ $issueLabel }}
                    ...
                    <div class="stats">
                        ...
                        <div class="stat">
                            ...
                            <div class="v" style="font-size: 13px">{{ $summary['from'] }}</div>
                        </div>
                        <div class="stat">
                            <div class="k">To</div>
                            <div class="v" style="font-size: 13px">{{ $summary['to'] }}</div>
                        </div>
                    </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style="width: 160px">Animal</th>
                                <th style="width: 120px">Category</th>
                                <th>Issue / Vaccine / Disease</th>
                                <th>Notes</th>
                        ...
                        <tbody>
                            @forelse($rows as $r)
                                @php
                                    ...
                                    } elseif (($r['category'] ?? '') === 'Disease Treatment') {
