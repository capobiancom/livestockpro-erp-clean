...
<div class="text-center">
    ...
    <h2 class="text-3xl font-bold text-gray-800 mb-3">Welcome to LivestockPro ERP</h2>
    <p class="text-gray-500 mb-8 max-w-xl mx-auto">
        This wizard will guide you through setting up your LivestockPro ERP installation in just a few minutes.
