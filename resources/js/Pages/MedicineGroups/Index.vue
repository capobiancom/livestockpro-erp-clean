<template>
    <Layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Manage your medicine groups.
                    </p>
                </div>
                <Link
                    :href="route('medicine-groups.create')"
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div
                v-if="medicineGroups.data.length === 0"
            ...
            >
                ...
                <p class="text-gray-500 mb-4">
                    Get started by adding your first medicine group.
                </p>
                <Link
                    :href="route('medicine-groups.create')"
                ...
                >
                    ...
                    Add Your First Medicine Group
                </Link>
            </div>

            <table v-else class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-indigo-700 to-blue-500">
                    <tr>
                        <th
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr
                        v-for="group in medicineGroups.data"
                        :key="group.id"
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center justify-center gap-2">
                                <Link
                                    :href="
                                        route('medicine-groups.show', group.id)
                                    "
        ...
        <!-- Pagination -->
        <div
            v-if="medicineGroups.links.length > 3"
            class="bg-gray-50 px-6 py-4 border-t border-gray-200"
        >
            <div class="flex justify-center gap-1">
                <Link
                    v-for="(link, index) in medicineGroups.links"
                    :key="index"
                    :href="link.url"
                    v-html="link.label"
                    :class="[
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    Are you sure you want to delete this medicine group? This
...
const props = defineProps({
    medicineGroups: Object,
    filters: Object,
});

const searchQuery = ref(props.filters.q || "");
const showDeleteModal = ref(false);
const medicineGroupToDelete = ref(null);
...
const clearSearch = () => {
    searchQuery.value = "";
    handleSearch(); // Trigger search immediately after clearing
};

const form = useForm({});

const confirmDelete = (id) => {
    medicineGroupToDelete.value = id;
    showDeleteModal.value = true;
};

const deleteMedicineGroup = () => {
    form.delete(route("medicine-groups.destroy", medicineGroupToDelete.value), {
        onSuccess: () => {
            showDeleteModal.value = false;
            medicineGroupToDelete.value = null;
        },
        onError: (errors) => {
            alert("Error deleting medicine group: " + errors.message);
        },
    });
};
