<template>
    <Head title="Edit Calving Record" />
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Edit the calving event information
                    </p>
                ...
                >
                    <Link
                        :href="route('calving-records.show', calvingRecord.id)"
...
const form = useForm({
    pregnancy_id: props.calvingRecord.pregnancy_id,
    calving_date: props.calvingRecord.calving_date
        ? new Date(props.calvingRecord.calving_date).toISOString().split("T")[0]
        : "",
    calving_type: props.calvingRecord.calving_type,
    calves_count: props.calvingRecord.calves_count,
    calf_gender: props.calvingRecord.calf_gender || "",
    calving_outcome: props.calvingRecord.calving_outcome,
    notes: props.calvingRecord.notes || "",
});

function submit() {
    form.put(route("calving-records.update", props.calvingRecord.id));
}
</script>
