<template>
    <Head title="Record Artificial Insemination" />
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                >
                    ...
                    >
                        ...
                        {{ form.processing ? "Saving..." : "Save AI Record" }}
                    </button>
                </div>
            </div>
        </form>
...
const form = useForm({
    animal_id: "", // New form field for animal_id
    event: "insemination", // Default event for AI
    semen_batch_no: "",
    breed_id: "", // New form field for breed_id
    semen_company: "",
    insemination_date: "",
    vet_id: "",
    cost: 0,
...
function submit() {
    form.post(route("artificial-inseminations.store"));
}
</script>
