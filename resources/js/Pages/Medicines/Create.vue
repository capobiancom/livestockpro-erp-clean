            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                >
                    ...
                    >
                        ...
                        {{
                            form.processing ? "Creating..." : "Create Medicine"
                        }}
                    </button>
                </div>
            </div>
...
const form = useForm({
    name: "",
    sku: "",
    medicine_group_id: "", // Change to medicine_group_id
    supplier_id: "",
    quantity: "",
    unit: "",
    min_quantity: "",
...
const submit = () => {
    form.farm_id = props.farms[0]?.id; // Assuming a single farm for farm owner
