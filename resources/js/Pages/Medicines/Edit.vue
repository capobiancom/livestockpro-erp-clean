            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Enter the medicine's primary identification details
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p
                                v-if="form.errors.medicine_group_id"
                                class="text-red-500 text-sm mt-1"
                            >
                                {{ form.errors.medicine_group_id }}
                            </p>
                        </div>
...
const props = defineProps({
    ...
    suppliers: Array,
    categories: Array,
    medicineGroups: Array, // Add medicineGroups to props
    errors: Object,
});
...
const form = useForm({
    ...
    medicine_group_id: props.medicine?.medicine_group_id ?? null, // Change to medicine_group_id
    supplier_id: props.medicine?.supplier_id ?? null,
    quantity: props.medicine?.quantity ?? 0,
    unit: props.medicine?.unit || "",
    min_quantity: props.medicine?.min_quantity ?? 0,
    unit_cost: props.medicine?.unit_cost ?? 0.0,
    description: props.medicine?.description || "",
    farm_id: props.medicine?.farm_id ?? null,
    inventory_category_id: props.medicine?.inventory_category_id ?? null,
});
