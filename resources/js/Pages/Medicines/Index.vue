<template>
    <Layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Track and manage your medicine items and stock levels
                    </p>
                </div>
                <Link
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div v-if="medicines.data.length === 0" class="text-center py-12">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="text-gray-500 mb-4">
                    Get started by adding your first medicine item to the
                    system.
                </p>
                <Link
                    :href="route('medicines.create')"
                    ...
                    >
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                <span
                                    :class="getStockLevelClass(medicine)"
...
const props = defineProps({
    medicines: Object,
    statistics: Object, // Add statistics to props
    filters: Object,
});
...
const deleteMedicine = () => {
    Inertia.delete(`/medicines/${medicineToDelete.value.id}`, {
        onSuccess: () => {
