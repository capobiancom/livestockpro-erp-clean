            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Update payroll item details for
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update the details for the payroll item
                    </p>
...
const form = useForm({
    payroll_run_id: props.payrollItem.payroll_run_id || "",
    employee_id: props.payrollItem.employee_id || "",
    basic_salary: props.payrollItem.basic_salary || 0,
    house_allowance: props.payrollItem.house_allowance || 0,
    medical_allowance: props.payrollItem.medical_allowance || 0,
    transport_allowance: props.payrollItem.transport_allowance || 0,
    overtime_hours: props.payrollItem.overtime_hours || 0,
    overtime_rate: props.payrollItem.overtime_rate || 0,
    overtime_amount: props.payrollItem.overtime_amount || 0,
    gross_salary: props.payrollItem.gross_salary || 0,
    deductions: props.payrollItem.deductions || 0,
    net_salary: props.payrollItem.net_salary || 0,
});

const submit = () => {
    form.post(`/payroll-items/${props.payrollItem.id}`);
};
</script>
