<template>
    <Head title="Edit Pregnancy Checkup" />

    <Layout>
        <template #title>
            <h2 class="text-3xl font-bold text-gray-800">
                Edit Pregnancy Checkup
            </h2>
        </template>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Edit the pregnancy checkup information
                    </p>
...
const form = useForm({
    pregnancy_id: props.pregnancyCheckup.pregnancy_id,
    checkup_date: props.pregnancyCheckup.checkup_date
        ? new Date(props.pregnancyCheckup.checkup_date)
              ...
              .replace(/,/, "")
        : "",
    checkup_result: props.pregnancyCheckup.checkup_result,
    observations: props.pregnancyCheckup.observations || "",
    checked_by: props.pregnancyCheckup.checked_by || "",
});
...
function submit() {
    form.put(route("pregnancy-checkups.update", props.pregnancyCheckup.id));
}
</script>
