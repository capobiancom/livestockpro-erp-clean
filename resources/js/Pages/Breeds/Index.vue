<template>
    <Layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Manage animal breeds and their characteristics
                    </p>
                </div>
                <Link
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr
                            v-for="breed in breeds.data"
                            :key="breed.id"
                            class="hover:bg-emerald-50 transition duration-150"
                        >
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div
                                        class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-emerald-100 text-emerald-600 font-bold"
                                    >
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    <Link
                                        :href="route('breeds.show', breed.id)"
                                    ...
                                    <Link
                                        ...
                                        class="text-emerald-600 hover:text-emerald-800 font-semibold transition"
                                        title="Edit Breed"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                >
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">
                                        Click "Add New Breed" to create your
                                        first breed
                                    </p>
                                </div>
                            </td>
            ...
            <!-- Pagination -->
            <div
                v-if="breeds.links.length > 3"
                class="bg-gray-50 px-6 py-4 border-t border-gray-200"
            >
                <div class="flex justify-center gap-1">
                    <Link
                        v-for="(link, index) in breeds.links"
                        :key="index"
                        :href="link.url"
                        v-html="link.label"
                        :class="[
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    <span class="font-semibold">{{ breedToDelete?.name }}</span
...
const confirmDelete = (breed) => {
    breedToDelete.value = breed;
    showDeleteModal.value = true;
};

const deleteBreed = () => {
    Inertia.delete(`/breeds/${breedToDelete.value.id}`, {
        onSuccess: () => {
            showDeleteModal.value = false;
            breedToDelete.value = null;
        },
    });
};
</script>
