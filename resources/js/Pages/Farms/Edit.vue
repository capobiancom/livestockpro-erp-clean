<template>
    <Layout>
        <template #title>
            <h2 class="text-3xl font-bold text-gray-800"> {{ $t('edit_farm') }} </h2>
        </template>
...
const form = useForm({
    ...
    contact_name: props.farm.contact_name || "",
    contact_phone: props.farm.contact_phone || "",
});
