<template>
    <Layout>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr v-if="!eventTypes.data.length">
                            <td colspan="2" class="px-6 py-12 text-center">
                                ...
                                >
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">
                                        Click "Add New Event Type" to create
                                        your first event type
                                    </p>
                                </div>
                            </td>
                        </tr>
            ...
            <!-- Pagination -->
            <div
                v-if="eventTypes.links.length > 3"
                class="bg-gray-50 px-6 py-4 border-t border-gray-200"
            >
                <div class="flex justify-center gap-1">
                    <Link
                        v-for="(link, index) in eventTypes.links"
                        :key="index"
                        :href="link.url"
                        v-html="link.label"
                        :class="[
...
const deleteEventType = () => {
    Inertia.delete(route("event-types.destroy", eventTypeToDelete.value.id), {
        onSuccess: () => {
