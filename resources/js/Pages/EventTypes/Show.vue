            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <Link
                        ...
                        class="bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition duration-200 flex items-center gap-2"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5"
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900">{{
                                formatDateTime(eventType.updated_at)
                            }}</span>
                        </div>
                    </div>
                </div>
...
const confirmDelete = () => {
    eventTypeToDelete.value = props.eventType;
    showDeleteModal.value = true;
};

const deleteEventType = () => {
    Inertia.delete(route("event-types.destroy", props.eventType.id), {
        onSuccess: () => {
