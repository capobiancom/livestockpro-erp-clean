            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Update payroll run details for
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update the details for the payroll run
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            >
                                Month <span class="text-rose-500">*</span>
                            </label>
                            <select
                                v-model="form.month"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent transition"
                                :class="{
                                    'border-red-500': form.errors.generated_at,
                                }"
                            />
                            <p
                                v-if="form.errors.generated_at"
                                class="mt-1 text-sm text-red-600"
                            >
                                {{ form.errors.generated_at }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    <Link
                        :href="route('payroll-runs.show', payrollRun.id)"
...
const form = useForm({
    farm_id: props.payrollRun.farm_id || "",
    user_id: props.payrollRun.user_id || "",
    month: props.payrollRun.month || "",
    year: props.payrollRun.year || "",
    status: props.payrollRun.status || "draft",
    generated_at: props.payrollRun.generated_at
        ? new Date(props.payrollRun.generated_at).toISOString().split("T")[0]
        : "",
});

const submit = () => {
    form.put(`/payroll-runs/${props.payrollRun.id}`);
};
</script>
