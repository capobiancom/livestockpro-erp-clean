<template>
    ...
    <Layout>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div
                v-if="designations.data.length === 0"
            ...
            >
                ...
                <p class="text-gray-500 mb-4">
                    Get started by adding your first designation to the system.
                </p>
                <Link
                    :href="route('designations.create')"
...
const deleteDesignation = () => {
    form.delete(route("designations.destroy", designationToDelete.value.id), {
        onSuccess: () => {
