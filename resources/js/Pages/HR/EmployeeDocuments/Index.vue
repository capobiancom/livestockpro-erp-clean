...
const currentDocumentPath = ref(null);
...
const viewDocument = (filePath, documentType) => {
...
const closeDocumentViewer = () => {
    ...
    currentDocumentPath.value = null;
...
const deleteEmployeeDocument = () => {
    Inertia.delete(
        route("employee-documents.destroy", documentToDelete.value.id),
        {
            onSuccess: () => {
...
<template>
    ...
    <AppLayout>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div
                v-if="employeeDocuments.data.length === 0"
            ...
            >
                ...
                <p class="text-gray-500 mb-4">
                    Get started by adding your first employee document to the
                    system.
                </p>
                <Link
                    :href="route('employee-documents.create')"
            ...
            <table v-else class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <template
                        v-for="(document, index) in employeeDocuments.data"
        ...
        <!-- Pagination -->
        <div
            v-if="employeeDocuments.links.length > 3"
            class="bg-gray-50 px-6 py-4 border-t border-gray-200"
        >
            <div class="flex justify-center gap-1">
                <Link
                    v-for="(link, index) in employeeDocuments.links"
                    :key="index"
                    :href="link.url"
                    v-html="link.label"
                    :class="[
            ...
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    <span class="font-semibold"
                        >document for
                        {{ documentToDelete?.employee.first_name }}
                        {{ documentToDelete?.employee.last_name }}</span
