...
const deleteShift = () => {
    form.delete(route("shifts.destroy", shiftToDelete.value.id), {
        onSuccess: () => {
    ...
    <Layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    >
                        ...
                        <p class="text-gray-500 mb-4">
                            Get started by adding your first shift to the
                            system.
                        </p>
                        <Link
                            :href="route('shifts.create')"
                ...
                <!-- Pagination -->
                <div
                    v-if="shifts.links.length > 3"
                    class="bg-gray-50 px-6 py-4 border-t border-gray-200"
                >
                    <div class="flex justify-center gap-1">
                        <Link
                            v-for="(link, index) in shifts.links"
                            :key="index"
                            :href="link.url"
                            v-html="link.label"
                            :class="[
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    <span class="font-semibold">{{ shiftToDelete?.name }}</span
