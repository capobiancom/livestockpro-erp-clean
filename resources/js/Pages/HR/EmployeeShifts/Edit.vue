<template>
    <Layout title="Edit Employee Shift">
        <template #title>
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Update employee shift assignment details
                    </p>
                </div>
                <Link
        ...
        <form @submit.prevent="updateEmployeeShift" class="mt-6">
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update the employee shift assignment details.
                    </p>
...
const form = useForm({
    ...
    effective_from: props.employeeShift.effective_from
        ? new Date(props.employeeShift.effective_from)
              .toISOString()
              .split("T")[0]
        : "",
    effective_to: props.employeeShift.effective_to
        ? new Date(props.employeeShift.effective_to).toISOString().split("T")[0]
        : "",
});

const updateEmployeeShift = () => {
    form.put(route("employee-shifts.update", props.employeeShift.id), {
        onSuccess: () => {
            // Handle success
        },
        onError: () => {
