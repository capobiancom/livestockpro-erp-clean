...
const employeeShiftToDelete = ref(null);

const form = useForm({});

const confirmDelete = (employeeShift) => {
    employeeShiftToDelete.value = employeeShift;
    showDeleteModal.value = true;
};

const deleteEmployeeShift = () => {
    form.delete(
        route("employee-shifts.destroy", employeeShiftToDelete.value.id),
        {
            onSuccess: () => {
                showDeleteModal.value = false;
                employeeShiftToDelete.value = null;
            },
            onError: () => {
                // Handle error
            },
    ...
    <Layout title="Employee Shifts">
        <template #title>
            <div class="flex items-center justify-between">
                ...
                <Link
                    :href="route('employee-shifts.create')"
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div
                        v-if="employeeShifts.data.length === 0"
                    ...
                    >
                        ...
                        <p class="text-gray-500 mb-4">
                            Get started by assigning a shift to an employee.
                        </p>
                        <Link
                            :href="route('employee-shifts.create')"
                            class="inline-flex items-center bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white px-6 py-3 rounded-lg font-semibold"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 mr-2"
                    ...
                    <table v-else class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr
                                v-for="employeeShift in employeeShifts.data"
                            ...
                            >
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    >
                                        ...
                                        {{ employeeShift.employee.last_name }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <!-- Pagination -->
                <div
                    v-if="employeeShifts.links.length > 3"
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    Are you sure you want to delete this employee shift? This
