<template>
    <Layout title="Employee Shift Details">
        <template #title>
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <Link
                        :href="route('employee-shifts.edit', employeeShift.id)"
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900">{{
                                formatDateTime(employeeShift.created_at)
                            }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Last Updated:</span>
                            <span class="font-medium text-gray-900">{{
                                formatDateTime(employeeShift.updated_at)
                            }}</span>
                        </div>
                    </div>
                </div>
