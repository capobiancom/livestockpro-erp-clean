<template>
    ...
    <Layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Track and manage your organization's employees
                    </p>
                </div>
                <Link
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-700 mt-1">
                            {{ employeeTypeCounts.full_time || 0 }}
                        </p>
                    </div>
            ...
            <div
                class="bg-gradient-to-br from-green-50 to-teal-50 rounded-lg shadow-md p-5 border border-green-200"
            >
                <div class="flex items-center justify-between">
                    <div>
...
const employeeTypeCounts = computed(() => {
    const counts = {
        full_time: 0,
        part_time: 0,
        contract: 0,
    ...
    props.employees.data.forEach((employee) => {
        if (counts[employee.employment_type] !== undefined) {
            counts[employee.employment_type]++;
        }
    });
    return counts;
});

const employeeStatusCounts = computed(() => {
    const counts = {
        active: 0,
        inactive: 0,
        terminated: 0,
    ...
    props.employees.data.forEach((employee) => {
        if (counts[employee.status] !== undefined) {
