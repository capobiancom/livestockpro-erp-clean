...
const props = defineProps({
    invoices: Object, // Changed from customerPayments to invoices
    filters: Object,
    statistics: Object,
...
const deletePayment = () => {
    Inertia.delete(
        route("customer-payments.destroy", paymentToDelete.value.id),
        {
            onSuccess: () => {
...
const getInvoiceTypeLabel = (type) => {
    if (type === "App\\Models\\Sale") {
        return "Sale Invoice";
    } else if (type === "App\\Models\\MilkSale") {
        return "Milk Sale Invoice";
    }
    return "Invoice";
};
</script>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Manage your customer payment records
                    </p>
                </div>
                <Link
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-700 mt-1">
                            {{ app_currency_symbol || "BDT" }}
                            {{ statistics?.total_amount_paid || 0 }}
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-700 mt-1">
                            {{ app_currency_symbol || "BDT" }}
                            {{ statistics?.this_month_payments || 0 }}
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-amber-700 mt-1">
                            {{ app_currency_symbol || "BDT" }}
                            {{ statistics?.this_year_payments || 0 }}
                        </p>
                    </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <tr
                                v-for="payment in invoice.sale_transactions"
                                :key="payment.id"
                            ...
                            >
                                ...
                                <td class="px-6 py-2 text-sm text-gray-600">
                                    <!-- Customer name already displayed in parent invoice row -->
                                </td>
                                <td class="px-6 py-2 text-sm text-gray-600">
                                    Payment
                                </td>
