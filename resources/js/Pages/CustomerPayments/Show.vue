        ...
        <template #title>
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <Link
                        :href="
                            route('customer-payments.edit', customerPayment.id)
                        "
                        ...
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="border-l-4 border-emerald-400 pl-4">
                                ...
                                >
                                    {{
                                        formatDate(
                                            customerPayment.transaction_date,
                                        )
                                    }}
                                </dd>
                            </div>
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900">{{
                                formatDateTime(customerPayment.created_at)
                            }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Last Updated:</span>
                            <span class="font-medium text-gray-900">{{
                                formatDateTime(customerPayment.updated_at)
                            }}</span>
                        </div>
                    </div>
                </div>
...
const deletePayment = () => {
    if (
        confirm(
            "Are you sure you want to delete this customer payment? This action cannot be undone.",
        )
    ) {
        useForm({}).delete(
            route("customer-payments.destroy", props.customerPayment.id),
        );
    }
};
</script>
