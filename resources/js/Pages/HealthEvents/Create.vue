            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Record a new health event in the system
                    </p>
                </div>
                <Link
        ...
        <form @submit.prevent="submit" class="mt-6">
            <div class="bg-white rounded-lg shadow-lg p-8">
                <div class="mb-8">
                    ...
                    >
                        <span
                            class="bg-gradient-to-r from-red-500 to-rose-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm"
                            >1</span
                        >
                        Event Information
                    </h3>
                    <p class="text-sm text-gray-500 mb-4">
                        Enter the health event details
                    </p>
                ...
                >
                    ...
                    <button
                        ...
                        class="px-8 py-3 bg-gradient-to-r from-red-500 to-rose-500 hover:from-red-600 hover:to-rose-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                        <svg
                        ...
                        {{
                            form.processing ? "Saving..." : "Save Health Event"
                        }}
                    </button>
                </div>
            </div>
...
const form = useForm({
    animal_id: "",
    event_type_id: "",
    health_issue_id: "", // Initialize health_issue_id
    title: "",
    description: "",
    occurred_at: "",
    resolved_at: "",
