<template>
    <Head title="Health Issues Management" />
    ...
    <Layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Track diseases, diagnoses, and treatment history
                    </p>
                </div>
                <Link
                    :href="route('health-issues.create')"
                    class="bg-gradient-to-r from-red-500 ml-5 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition duration-200 flex items-center gap-2"
                >
                    <svg
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div
                class="bg-gradient-to-br from-red-50 to-pink-50 rounded-lg shadow-md p-5 border border-red-200"
            >
                <div class="flex items-center justify-between">
                    <div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div
                v-if="healthIssues.data.length === 0"
            ...
            >
                ...
                <p class="text-gray-500">
                    No health issues have been recorded yet.
                </p>
            </div>
            ...
            <div v-else class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr
                            v-for="issue in healthIssues.data"
                            :key="issue.id"
                        ...
                        >
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    :class="{
                                        ...
                                        'bg-yellow-100 text-yellow-800':
                                            issue.status === 'chronic',
                                        'bg-gray-100 text-gray-800':
                                            issue.status === 'deceased',
                                    }"
                                >
                                    {{ issue.status }}
                                </span>
                            ...
                            >
                                ...
                                >
                                    <Link
                                        :href="route('health-issues.show', issue.id)"
                                    ...
                                    <Link
                                        :href="route('health-issues.edit', issue.id)"
        ...
        <!-- Pagination -->
        <div
            v-if="healthIssues.links.length > 3"
            class="bg-gray-50 px-6 py-4 border-t border-gray-200"
        >
            <div class="flex justify-center gap-1">
                <Link
                    v-for="(link, index) in healthIssues.links"
                    :key="index"
                    :href="link.url"
                    v-html="link.label"
                    :class="[
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    ({{ issueToDelete?.disease?.name || "N/A" }})? This action
                    cannot be undone.
                </p>
...
const activeCount = computed(() => {
    return props.healthIssues.data.filter((i) => i.status === "active").length;
});

const recoveredCount = computed(() => {
    return props.healthIssues.data.filter((i) => i.status === "recovered")
        .length;
});

const chronicCount = computed(() => {
    return props.healthIssues.data.filter((i) => i.status === "chronic").length;
});
...
const deleteIssue = () => {
    Inertia.delete(`/health-issues/${issueToDelete.value.id}`, {
        onSuccess: () => {
