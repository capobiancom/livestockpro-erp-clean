<template>
    <Head title="Record Health Issue" />
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Enter the health issue identification details
                    </p>
                ...
                <div class="mb-8 pt-8 border-t border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Record symptoms, diagnosis, and medical observations
                    </p>
                ...
                >
                    ...
                    >
                        ...
                        {{
                            form.processing ? "Saving..." : "Save Health Issue"
                        }}
                    </button>
                </div>
            </div>
