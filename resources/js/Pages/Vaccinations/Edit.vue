        ...
        <template #title>
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Edit a Vaccination administered to an animal in your farm.
                </p>
            </div>
        </template>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="flex gap-3 mt-6 justify-end">
                    ...
                    >
                        ...
                        <span v-else>Update Vaccination Record</span>
                    </button>
                    <Link
...
const form = useForm({
    animal_id: props.vaccination.animal_id,
    disease_id: props.vaccination.disease_id || "",
    administered_at: props.vaccination.administered_at
        ? props.vaccination.administered_at.substring(0, 16)
        : "",
    next_due_at: props.vaccination.next_due_at
        ? props.vaccination.next_due_at.substring(0, 16)
        : "",
    staff_id: props.vaccination.staff_id || "",
    notes: props.vaccination.notes || "",
    medications: props.vaccination.medications.map((med) => ({
        id: med.id,
...
function submit() {
    form.put(`/vaccinations/${props.vaccination.id}`);
}
</script>
