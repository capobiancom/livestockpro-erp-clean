        ...
        <form @submit.prevent="submit" class="mt-6">
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Update the supplier's basic identification details</p>
                ...
                <div class="mb-8 pt-8 border-t border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Update contact information for this supplier</p>
                ...
                <div class="mb-8 pt-8 border-t border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Update the supplier's physical address</p>
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                    ...
                    <button
                        ...
                        class="px-8 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
