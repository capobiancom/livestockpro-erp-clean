        ...
        <template #title>
            <div class="flex items-center justify-between">
                ...
                <Link
                    ...
                    class="bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white ml-5 px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition duration-200 flex items-center gap-2"
                >
                    <svg
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">
                                <span
                                    class="px-2 py-1 bg-indigo-100 rounded text-xs font-medium"
                                >
                            ...
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                >
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">
                                        Click "Add Supplier" to create your
                                        first supplier
                                    </p>
                                </div>
                            </td>
