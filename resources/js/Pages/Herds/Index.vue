            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Manage herds across your farms
                    </p>
                </div>
                <Link
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        >
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div
                                        class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 font-bold"
                                    >
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <Link
                                        :href="route('herds.edit', herd.id)"
                                        class="text-blue-600 hover:text-blue-800 font-medium transition p-2 hover:bg-blue-50 rounded"
                                        title="Edit"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <td colspan="5" class="px-6 py-12 text-center">
                                ...
                                >
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">
                                        Click "Add New Herd" to create your
                                        first herd
                                    </p>
                                </div>
                            </td>
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    <span class="font-semibold">{{ herdToDelete?.name }}</span
...
const deleteHerd = () => {
    Inertia.delete(`/herds/${herdToDelete.value.id}`, {
        onSuccess: () => {
