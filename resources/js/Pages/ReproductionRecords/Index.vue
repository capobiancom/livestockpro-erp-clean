            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Track and manage breeding and reproduction events
                    </p>
                </div>
                <Link
                    :href="route('reproduction-records.create')"
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">
                                <span
                                    class="px-2 py-1 bg-pink-100 rounded text-xs font-medium"
                                >
                                    {{ record.event }}
                                </span>
                            </td>
                            <td class="px-6 py-4">
                                ...
                                >
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-blue-100 text-blue-800 w-fit"
                                    >
                                        {{ record.partner.tag }}
                                    </span>
                                    <span
                                        v-if="record.partner.name"
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    <Link
                                        :href="route('reproduction-records.show', record.id)"
                            ...
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                >
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">
                                        Click "Add Record" to create your first
                                        reproduction record
                                    </p>
                                </div>
                            </td>
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    Are you sure you want to delete this reproduction record?
...
const deleteRecord = () => {
    Inertia.delete(`/reproduction-records/${recordToDelete.value.id}`, {
        onSuccess: () => {
