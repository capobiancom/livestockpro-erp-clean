<template>
    ...
    <Layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Track and manage animal pregnancies
                    </p>
                </div>
                <Link
                    :href="route('pregnancies.create')"
                    ...
                    <div class="flex-1">
                        <div class="relative">
                            <input
                                ...
                                @input="handleSearch"
                                type="text"
                                placeholder="Search by animal tag or pregnancy status..."
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-yellow-700 mt-1">
                            {{ statistics.average_gestation_days }} days
                        </p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr
                            v-for="pregnancy in pregnancies.data"
                            :key="pregnancy.id"
                        ...
                        <tr v-if="!pregnancies.data.length">
                            <td colspan="5" class="px-6 py-12 text-center">
                                ...
                                >
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">
                                        Click "Add Pregnancy Record" to create
                                        your first pregnancy record
                                    </p>
                                </div>
                            </td>
                        </tr>
            ...
            <!-- Pagination -->
            <div
                v-if="pregnancies.links.length > 3"
                class="bg-gray-50 px-6 py-4 border-t border-gray-200"
            >
                <div class="flex justify-center gap-1">
                    <Link
                        v-for="(link, index) in pregnancies.links"
                        :key="index"
                        :href="link.url"
                        v-html="link.label"
                        :class="[
        ...
        >
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    Are you sure you want to delete this pregnancy record? This
...
const confirmDelete = (pregnancy) => {
    recordToDelete.value = pregnancy;
    showDeleteModal.value = true;
};

const deleteRecord = () => {
    Inertia.delete(route("pregnancies.destroy", recordToDelete.value.id), {
        onSuccess: () => {
