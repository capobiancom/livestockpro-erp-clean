    ...
    <Layout>
        <template #title>
            <div class="flex items-center justify-between">
                ...
                <Link
                    :href="route('cash-transactions.show', cashTransaction.id)"
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update the transaction's information
                    </p>
...
const form = useForm({
    cash_account_id: props.cashTransaction.cash_account_id || "",
    transaction_date: props.cashTransaction.transaction_date
        ? new Date(props.cashTransaction.transaction_date).toISOString().split("T")[0]
        : "",
    amount: props.cashTransaction.amount || "",
    direction: props.cashTransaction.direction || "",
    description: props.cashTransaction.description || "",
    payment_method: props.cashTransaction.payment_method || "",
    reference_type: props.cashTransaction.reference_type || "",
    reference_id: props.cashTransaction.reference_id || "",
});
...
const submit = () => {
    form.put(route("cash-transactions.update", props.cashTransaction.id));
};
</script>
