            ...
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Total feed issued to each animal from stock movements
                        (feeding consumption). Filter by date range and animal,
                        then export or print for reporting.
                    </p>
                </div>
                    ...
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            <div
                                class="text-xs font-medium uppercase tracking-wide text-gray-500"
                            >
                                Avg daily feed (overall)
                            </div>
                            <div
                                class="mt-2 text-2xl font-semibold text-gray-900"
                            >
                                {{ number(summary.avg_daily_feed_overall) }}
                            </div>
                        </div>
                        <div
...
const form = reactive({
    ...
    sort: props.filters.sort ?? "animal",
...
function exportCsv() {
    ...
    a.href = url;
    a.download = `feed-consumed-per-animal.csv`;
