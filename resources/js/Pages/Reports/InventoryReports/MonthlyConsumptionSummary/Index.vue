                ...
                <div class="border-b border-gray-200 px-4 py-3">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-xs text-gray-500">
                            Tip: Choose a month to calculate totals for that
                            period.
                        </div>
                    </div>
                </div>
...
const form = reactive({
    ...
    item_type: props.filters.item_type ?? "inventory",
...
function printReport() {
    ...
    const url = `/reports/inventory/monthly-consumption-summary/print?${params.toString()}`;
    window.open(url, "_blank", "noopener,noreferrer");
}

function exportCsv() {
    const headers = ["Item", "Unit", "Quantity", "Cost"];
    ...
    a.href = url;
    a.download = `monthly-consumption-summary-${form.month || "month"}.csv`;
