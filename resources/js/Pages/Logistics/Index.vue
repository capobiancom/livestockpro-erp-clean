<template>
    <Layout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Track animal transportation and logistics operations
                    </p>
                </div>
                <Link
                    :href="route('logistics.create')"
                    class="bg-gradient-to-r from-cyan-500 to-blue-500 ml-5 hover:from-cyan-600 hover:to-blue-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition duration-200 flex items-center gap-2"
                >
                    <svg
                    ...
                    <div class="flex-1">
                        <div class="relative">
                            <input
                                ...
                                @input="handleSearch"
                                type="text"
                                placeholder="Search by reference, from location, or to location..."
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-700 mt-1">
                            {{ statistics.total_animals_moved }}
                        </p>
                    </div>
            ...
            <div
                class="bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg shadow-md p-5 border border-orange-200"
            >
                <div class="flex items-center justify-between">
                    <div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">
                                <div>{{ logistic.from_location }}</div>
                                <div class="text-xs text-gray-500">
                                    → {{ logistic.to_location }}
                                </div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700">
                                <div>{{ logistic.vehicle || "-" }}</div>
                                <div class="text-xs text-gray-500">
                                    {{ logistic.driver || "-" }}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <Link
                                        ...
                                        class="text-cyan-600 hover:text-cyan-800 font-semibold transition"
                                        title="Edit Record"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <td colspan="7" class="px-6 py-12 text-center">
                                ...
                                >
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">
                                        Click "Add Logistics Record" to create
                                        your first record
                                    </p>
                                </div>
                            </td>
            ...
            <!-- Pagination -->
            <div
                v-if="logistics.links.length > 3"
                class="bg-gray-50 px-6 py-4 border-t border-gray-200"
            >
                <div class="flex justify-center gap-1">
                    <Link
                        v-for="(link, index) in logistics.links"
                        :key="index"
                        :href="link.url"
                        v-html="link.label"
                        :class="[
...
const logisticToDelete = ref(null);
...
const confirmDelete = (logistic) => {
    logisticToDelete.value = logistic;
    showDeleteModal.value = true;
};

const deleteLogistic = () => {
    Inertia.delete(`/logistics/${logisticToDelete.value.id}`, {
        onSuccess: () => {
            showDeleteModal.value = false;
            logisticToDelete.value = null;
        },
    });
};
