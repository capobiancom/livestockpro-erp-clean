            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Track and manage farm expenses and costs
                    </p>
                </div>
                <Link
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-orange-700 mt-1">
                            ${{ formatNumber(statistics.total_amount) }}
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-700 mt-1">
                            ${{ formatNumber(statistics.this_month) }}
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-700 mt-1">
                            ${{ formatNumber(statistics.this_year) }}
                        </p>
                    </div>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr
                            ...
                            :key="expense.id"
                            class="hover:bg-red-50 transition duration-150"
                        >
                            <td
...
const deleteExpense = () => {
    Inertia.delete(`/expenses/${expenseToDelete.value.id}`, {
        onSuccess: () => {
