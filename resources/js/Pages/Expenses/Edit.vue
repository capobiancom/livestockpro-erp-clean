            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Update expense information for {{ expense.title }}
                    </p>
                </div>
                <Link
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update the expense's primary details
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition"
                                :class="{
                                    'border-red-500': form.errors.incurred_on,
                                }"
                            />
                            <p
                ...
                <div class="mb-8 pt-8 border-t border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update associations with farm or staff member
                    </p>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <textarea
                                v-model="form.notes"
                                rows="4"
                                placeholder="Add any additional information or observations about this expense..."
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition"
                ...
                >
                    ...
                    <button
                        ...
                        class="px-8 py-3 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                        <svg
...
const form = useForm({
    ...
    incurred_on: props.expense.incurred_on || "",
    farm_id: props.expense.farm_id || null,
    staff_id: props.expense.staff_id || null,
