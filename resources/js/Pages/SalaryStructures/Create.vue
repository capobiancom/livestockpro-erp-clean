...
const form = useForm({
    ...
    overtime_rate: 0,
    effective_from: "", // Initialize as empty string for new record
});

const submit = () => {
    form.post(route("salary-structures.store"));
};
</script>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Fill in the details to create a new salary structure.
                    </p>
                </div>
                <Link
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Fill in the details for the salary structure.
                    </p>
