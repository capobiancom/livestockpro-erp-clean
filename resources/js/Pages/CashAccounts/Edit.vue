            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Update account information for {{ cashAccount.name }}
                    </p>
                </div>
                <Link
                    :href="route('cash-accounts.show', cashAccount.id)"
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update the account's primary details
                    </p>
                ...
                <div
                    class="mb-8 pt-8 border-t border-gray-200"
                ...
                <div class="mb-8 pt-8 border-t border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mb-4">
                        Update additional details and settings
                    </p>
...
const form = useForm({
    ...
    account_id: props.cashAccount.account_id || "",
    account_number: props.cashAccount.account_number || "",
    bank_name: props.cashAccount.bank_name || "",
    branch_name: props.cashAccount.branch_name || "",
    opening_balance: props.cashAccount.opening_balance || 0,
    is_active: props.cashAccount.is_active ?? true,
    description: props.cashAccount.description || "",
});

const submit = () => {
    form.put(route("cash-accounts.update", props.cashAccount.id));
};
</script>
