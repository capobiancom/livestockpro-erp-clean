            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 ml-11">
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer hover:bg-gray-50 transition-colors duration-200"
                                :class="{
                ...
                <div class="flex gap-3 mt-6">
                    ...
                    >
                        ...
                        <span v-else>Update Milk Record</span>
                    </button>
                    <Link
...
const form = useForm({
    ...
    quantity_liters: props.record.quantity_liters || "",
    staff_id: props.record.staff_id || "",
    notes: props.record.notes || "",
});

function submit() {
    form.put(`/milk-records/${props.record.id}`);
}
</script>
