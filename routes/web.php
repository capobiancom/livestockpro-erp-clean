...
/**
 * Health check route for Coolify and other monitoring tools.
 */
...
// Redireciona para o login se não estiver autenticado e tentar acessar qualquer rota não definida
