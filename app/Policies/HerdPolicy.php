...
class HerdPolicy
{
    ...
    {
        return $user->hasRole('farm owner') || $user->hasPermissionTo('herds.manage');
    }
    ...
    {
        return ($user->hasRole('farm owner') && $user->farm_id === $herd->farm_id) || $user->hasPermissionTo('herds.manage');
    }
